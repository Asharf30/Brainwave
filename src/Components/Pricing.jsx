    ...
    <Section className="overflow-hidden" id="pricing">
      <div className="container relative z-2">
        ...
        <div className="flex gap-[1rem] max-lg:flex-wrap pricing-anim">
          {pricing.map((item) => (
            <div key={item.id} className="w-[19rem] max-lg:w-full h-full px-6 bg-n-8 border border-n-6 rounded-[2rem] lg:w-auto even:py-14 odd:py-8 odd:my-4 transition-transform duration-300 hover:scale-105 hover:shadow-xl hover:shadow-color-1/20 cursor-pointer">
