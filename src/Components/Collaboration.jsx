...
import { collabApps, collabContent, collabText } from "../constants.jsx";
...
const Collaboration = () => {
  useGSAP(() => {
    gsap.fromTo(".collab-anim", { opacity: 0, x: -20 }, { opacity: 1, x: 0, duration: 1, stagger: 0.2, scrollTrigger: { trigger: "#collaboration", start: "top 80%" }});
  });

  return (
    <Section crosses id="collaboration">
      <div className="container lg:flex">
        <div className="max-w-[25rem] collab-anim">
        ...
        <div className="lg:ml-auto xl:w-[38rem] mt-4">
          <p className="body-2 mb-8 text-n-4 md:mb-16 lg:mb-32 lg:w-[22rem] lg:mx-auto collab-anim">{collabText}</p>
          <div className="relative left-1/2 flex w-[22rem] aspect-square border border-n-6 rounded-full -translate-x-1/2 scale:75 md:scale-100 collab-anim">
